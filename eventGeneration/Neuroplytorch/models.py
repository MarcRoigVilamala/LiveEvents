...
class PerceptionWindow(pl.LightningModule):
    ...
    """
    def __init__(self, perception_model: nn.Module, window_size: int, num_primitive_events: int, loss_str: str, lr: float):
        """
...
class UrbanModel(pl.LightningModule):
    ...
    def __init__(self, loss_str: str, lr: float):
        ...
        self.model = basic_models.FromVGGish(output_size=10)
...
#
#     if verify_result:
#         print("Successful, all possible permutations are correct")
#     else:
#         print("Above window failed logical check")
